export const MAD_LIBS = [
  {
    ...
    slots: [
      ...
      { id: 'adj3',  type: 'DESCRIPTION', hint: 'any descriptor',           examples: ['electric', 'fuzzy', 'metallic'] },
...

  {
    ...
    slots: [
      ...
      { id: 'adj3',  type: 'DESCRIPTION', hint: 'any descriptor',         examples: ['singing', 'invisible', 'edible'] },
...

  {
    ...
    slots: [
      ...
      { id: 'adj1',  type: 'DESCRIPTION', hint: 'any descriptor',              examples: ['quantum', 'artisanal', 'underwater'] },
